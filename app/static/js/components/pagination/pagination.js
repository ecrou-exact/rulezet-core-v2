...
export default {
    ...
    setup(props, { emit }) {
        const pages = computed(() => {
            ...
            // Always show first, last; fill middle with current ± window
            const half  = Math.floor((max - 2) / 2)        // slots for center wing
            const items = []

            // -- Leading ellipsis threshold
            const showLeadingEllipsis  = cur > half + 2
            // -- Trailing ellipsis threshold
